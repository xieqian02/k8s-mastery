...
` $ docker build -f Dockerfile -t $DOCKER_USER_ID/sa-webapp . `

## Running the container
``` 
$ docker run -d -p 8080:8080 -e SA_LOGIC_API_URL='http://<container_ip or docker machine ip>:5000' $DOCKER_USER_ID/sa-webapp  
```
...
` $ docker push $DOCKER_USER_ID/sa-webapp `
